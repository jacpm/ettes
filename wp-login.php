...
<script type="text/javascript" src="/wp-content/plugins/buddyboss-platform/bp-core/js/vendor/magnific-popup.js?ver=2.3.2" id="bp-nouveau-magnific-popup-js"></script>
...
<link rel="stylesheet" id="bp-nouveau-icons-map-css" href="/wp-content/plugins/buddyboss-platform/bp-templates/bp-nouveau/icons/css/icons-map.min.css?ver=2.3.2" type="text/css" media="screen">
<link rel="stylesheet" id="bp-nouveau-bb-icons-css" href="/wp-content/plugins/buddyboss-platform/bp-templates/bp-nouveau/icons/css/bb-icons.min.css?ver=1.0.3" type="text/css" media="screen">
<link rel="stylesheet" id="bp-nouveau-css" href="/wp-content/plugins/buddyboss-platform/bp-templates/bp-nouveau/css/buddypress.min.css?ver=2.3.2" type="text/css" media="screen">
		...
		<form name="loginform" id="loginform" action="http://localhost/Jac-P-Mash/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Inloggen">
					...
					<p id="nav">
				<a href="/register/">Registreren</a> | <a href="/wp-login.php?action=lostpassword">Je wachtwoord vergeten?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Ga naar Jac P Mash</a>		</p>
			</div>
...
<script type="text/javascript" src="/wp-includes/js/heartbeat.min.js?ver=6.2" id="heartbeat-js"></script>
<script type="text/javascript" src="/wp-content/plugins/buddyboss-platform/bp-core/js/vendor/codemirror.min.js?ver=2.3.2" id="bp-nouveau-codemirror-js"></script>
<script type="text/javascript" src="/wp-content/plugins/buddyboss-platform/bp-core/js/vendor/css.min.js?ver=2.3.2" id="bp-nouveau-codemirror-css-js"></script>
...
/* <![CDATA[ */
var userProfileL10n = {"user_id":"0","nonce":"debb445402"};
/* ]]> */
</script>
